...
@Entity//Perfaqson nje tabele ne db.
@Table(name="BOOKS")
public class Book {

	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)//Tregon qysh mi gjeneru vlerat n'kolona n'tabela
	//p.sh kur o default shkon e rrit per njo ne menyre automatike
	...
	//i hek entitetet prej persistent, ku edhe femija i entitetit heket,ose marge, etj
	@ManyToOne(cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH},
			fetch = FetchType.LAZY)//Fetch i thot hibernate me marr te dhena nga db veq n lidhje shume
	//osht psh kur e merr te fmija shkon edhe te prindi
